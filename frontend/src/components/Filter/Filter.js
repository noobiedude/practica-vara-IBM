...
//   const programmingLanguages = [`JavaScript`, `C++`, `Python`]

//   return (
//     <div>
//       {!isOpen && (
//         <div className={`filter-container`} onClick={e => setIsOpen(true)}>
//           <p className={`filter-text`}>Filtrare</p>
//         </div>
//       )}
//       {isOpen && (
//         <div className={`filter-open-container`}>
//           <p className={`filter-open-text`}>Filtreaza dupa:</p>
//           <label
//             htmlFor={`programmingLanguages`}
//             className={`filter-open-label`}
//           >
//             Limbaj programare:
//           </label>
//           <input
...
//           ></input>
//           <button onClick={e => setIsOpen(false)}>Inchide</button>
//         </div>
//       )}
//     </div>
//   )
